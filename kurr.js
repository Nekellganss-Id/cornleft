...
return url.match(new RegExp(/https?:\/\/(www\.)?[-a-zA-Z0-9@:%._+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9()@:%_+.~#?&/=]*)/, 'gi'))
		...
		const katalog = (teks) => {
             res = kurr.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*_©Nekell-Ganss_*", "thumbnail": ofrply, "surface": 'CATALOG' }}, {quoted:ftrol})
             kurr.relayWAMessage(res)
        }
        const grupinv = (teks) => {
        	grup = kurr.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6289695073357-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/Ic6pEQRdDBE7ZztU7DobrE', "groupName": `${NamaBot}`, "footerText": "*_©Nekell-Ganss_*", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
...
if(budy.includes('Nekell-Ganss')){
cpref = `Hayo Ngomongin Nekell Ganteng Yaaa Aowkowkwoo`
reply(cpref)
}
if(budy.includes('NekellTod')){
cpref = `Hayo Ngomongin Nekell Ganteng Yaaa Aowkowkwoo`
reply(cpref)
}
           if (budy.startsWith('>')){
...
sendButMessage(from, `${JSON.stringify(me, null, 2)}`, "*_©Nekell-Ganss_*", [{buttonId: 'igm', buttonText: {displayText: 'Instagram'}, type: 1},{buttonId: 'ytm', buttonText: {displayText: 'YouTube'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
}
if(isButton == 'igm'){
reply('http://instagram.com/nekellgatau')
}
if(isButton == 'fbm'){
reply('http://facebook.com/nekell-ganss')
}
...
└─────────────────❒`
sendButLocation(from, `${menu}`, "*_© NEKELL-GANSS_*", {jpegThumbnail:ofrply1,name:""}, [{buttonId:`store`,buttonText:{displayText:'𝙨𝙩𝙤𝙧𝙚 𝙢𝙚𝙣𝙪'},type:1},{buttonId:`sc`,buttonText:{displayText:'SC'},type:1},{buttonId:`catalog`,buttonText:{displayText:'CATALOG MENU'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
...
`
sendButLocation(from, `${menu}`, "*_© NEKELL-GANSS_*", {jpegThumbnail:ofrply1,name:""}, [{buttonId:`allmenu`,buttonText:{displayText:'ALL MENU'},type:1},{buttonId:`rules`,buttonText:{displayText:'RULES'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
else if(menusimpel = true){
        stod = `${sender}`
fill =`Hai Kak ${pushname}, ${tampilUcapan}
...
📥 BERMINAT ? HUBUNGI :
https://wa.me/+6289695073357 ( Nekell-Ganss )


*MATURSUWUN MONGGO DI LARISI*`
sendButLocation(from, `${menu}`, "*_© NEKELL-GANSS_*", {jpegThumbnail:ofrply1,name:""}, [{buttonId:`menu`,buttonText:{displayText:'BACK TO MENU'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
else if(menusimpel = true){
        stod = `${sender}`
fill =`Hai Kak ${pushname}, ${tampilUcapan}
...
MY GITHUB
[https://github.com/Nekellganss-id]

MY FACEBOOK
[https://facebook.com/nekell-ganss
   `
menu =`CornBotz`
gbutsan = [
...
ɢɪᴛʜᴜʙ ᴏᴡɴᴇʀ:https://github.com/Nekellganss-id
Facebook ᵒʷⁿᵉʳ:https://facebook.com/nekell-ganss`
sendButLocation(from, `${menu}`, "*_© NEKELL-GANSS_*", {jpegThumbnail:logonya,name:""}, [{buttonId:`menu`,buttonText:{displayText:'SIAP OM'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
break
case 'verify':
...
"templateMessage": {
						"hydratedTemplate": {
							...
							"hydratedFooterText": `NEKELL-GANSS`,
							"hydratedButtons": [
								{
									"quickReplyButton": {
    ...
    "hydratedButtons": [
      {
        "urlButton": {
          ...
          "url": "https://github.com/Nekellganss-id"
        },
        "index": 0
      }
    ]
...
case 'chiisaihentai':
              ...
              buttonsMessage = {footerText:'✗✗✗ NEKELL-GANSS', imageMessage: imageMsg,
              contentText:`Follow FB : nekell-ganss`,buttons,headerType:4}
...
case 'blackpink':
                ...
                if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
                    ...
                    getBuffer(`https://api.lolhuman.xyz/api/textprome/${command}?apikey=KurrXd&text=${ini_txt}`).then((gambar) => {
                        kurr.sendMessage(from, gambar, image, {thumbnail: Buffer.alloc(0), caption: `Follow FB : nekell-ganss`, quoted : ftrol})
                    })
                    break
                case 'pornhub':
                case 'glitch':
...
kurr.sendMessage(from, {url: `${pint[Math.floor(Math.random() * pint.length)]}`}, image, {quoted: mek, thumbnail: Buffer.alloc(0), caption: "Follow FB : nekell-ganss"})
break
case 'isbaileys': 
case 'bail': 
case 'baileys':
...
Giliran = @${tty.player1.split('@')[0]}`
 kurr.sendMessage(from, ucapan, text, {quoted: mek, contextInfo:{mentionedJid: [tty.player1,tty.player2]}})
     ...
     kurr.sendMessage(`${settings.NomorOwner}@s.whatsapp.net`, `─────「 *ALERT-ERROR* 」─────\n\n\`\`\`${e}\`\`\`\n\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer ${NamaBot}",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./logonya.jpeg'),sourceUrl:"https://wa.me/p/6349482305092740/6289695073357"}}})
	}
    }
    }
    }
